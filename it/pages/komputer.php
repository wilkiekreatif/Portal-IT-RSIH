...
<head>
    ...
    <title>Computer Inventory | IT Portal Management</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Master Komputer
                            <small>Detail Master Komputer</small>
                        </h1>
                        <ul class="breadcrumb">
                            <li>
                            ...
                            <li>
                                <i class="fa fa-calculator"></i> Master Komputer
                            </li>
                        </ul>
                        <?php
						...
						?>
                            <button type="button" class='btn btn-sm btn-success' data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"> </span> Tambah Komputer Baru</button> &nbsp; <a href='../controller/cetakkomp.php' target="_BLANK" class='btn btn-sm btn-primary'><span class="glyphicon glyphicon-print"> </span> Cetak Data</a>
                            <br><br>
                        <?php
							}
                        ?>
                            			...
                            			<table id="example" class="table table-hover table-striped table-bordered">
                                            ...
                                            <tbody>
                                    			<?php
													...
													$query="SELECT a.*,b.nama AS BAGIAN FROM mst_komputer a, mst_bagian b WHERE (status='0')AND(a.lokasi = b.id) ORDER BY tgl_terima DESC";
													//menjalankan query      
													...
													if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        while($row = mysqli_fetch_array($result)) {      
                                                            ...
                                                            <a href='editkomp.php?id=".$row['id_komp']."' class='btn btn-sm btn-default' id='CompEdit'> <i class='glyphicon glyphicon-edit'></i> Edit </a>";
                                                            ?>                                                            
                                                            <a href='hapuskomp.php?id=<?php echo($row['id_komp']);?>' class='btn btn-sm btn-danger' onclick="return confirm('Apakah anda yakin?');"> <i class='glyphicon glyphicon-inbox'> </i> Gudangkan</a>
                                                            <?php
															echo "</tr>";   
															$no++;
                                                        }
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <form action="../controller/vkomp.php" method="post">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
