                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Master Printer
                            <small>Edit Data Detail Master Printer</small>
                        </h1>
                        <ul class="breadcrumb">
                            <li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-print fa-fw"></i> Detail Printer</h3>
                            </div>
                            <div class="panel-body">
                                <form action="vprinteredit.php" method="post">
                                    <?php
                                        $id= $_GET['id'];
                                        $q = mysqli_query($connect,"SELECT * FROM mst_printer WHERE id_prnt='$id'");
										$data = mysqli_fetch_array($q);
									?>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deskripsi">Id Printer</label>
                                                <input readonly type="text" class="form-control" id="id" name="id" placeholder="Id Printer..." maxlength="35" value="<?php
                                                    echo($data['id_prnt']);
                                                ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="deskripsi">Tipe</label>
                                                <input required type="text" class="form-control" id="tipe" name="tipe" placeholder="Tipe Printer..." maxlength="35" value="<?php
                                                    echo($data['tipe']);
                                                ?>">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control" id="ip" name="ip" placeholder="Ip Address Server..." maxlength="35" value="<?php
                                            ...
                                            <a href='printer.php' class='btn btn-md btn-warning'> Kembali</a>
                                        </form>
                                </div>
                        </div>
                    </div>
