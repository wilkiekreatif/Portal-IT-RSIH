                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Master Komputer
                            <small>Edit Data Detail Master Komputer</small>
                        </h1>
                        <ul class="breadcrumb">
                            <li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-calculator fa-fw"></i> Detail Komputer</h3>
                            </div>
                            <div class="panel-body">
                                <form action="vkompedit.php" method="post">
                                    <?php
                                        $id= $_GET['id'];
                                        $q = mysqli_query($connect,"SELECT * FROM mst_komputer WHERE id_komp='$id'");
										$data = mysqli_fetch_array($q);
									?>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="deskripsi">Id Komputer</label>
                                                <input readonly type="text" class="form-control" id="idkomp" name="idkomp" placeholder="Deskripsi..." maxlength="35" value="<?php
                                                    echo($data['id_komp']);
                                                ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select required class="form-control" id="tipe" name="tipe">
                                                    ...
                                                    <?php
                                                        if($data['tipe']==='0'){
                                                            echo("<option selected value='0'>Laptop</option>");
                                                            echo("<option value='1'>Personal Computer</option>");
                                                        }else if($data['tipe']==='1'){
                                                            echo("<option value='0'>Laptop</option>");
                                                            echo("<option selected value='1'>Personal Computer</option>");
                                                        }else{
                                                            echo("<option value='0'>Laptop</option>");
                                                            echo("<option value='1'>Personal Computer</option>");
                                                        }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control" id="pengguna" name="pengguna" placeholder="Pengguna Komputer..." maxlength="35" value="<?php
                                                    echo($data['user']);
                                                ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control" id="tgl_garansi" name="tgl_garansi" placeholder="Tgl Garansi... (yyyy-mm-dd)" maxlength="35" value="<?php
                                                    echo($data['tgl_garansi']);
                                                ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="spesifikasi">Spesifikasi</label>
                                                <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="5" placeholder="Detail Spesifikasi pisahkan dengan koma dan spasi... contoh: (, )"><?php
                                                    echo($data['spesifikasi']);
                                                ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="tgl_garansi">IP Address</label>
                                                <input required type="text" class="form-control" id="ip_address" name="ip_address" placeholder="IP Address..." maxlength="15" value="<?php
                                                    echo($data['ip_address']);
                                                ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="tgl_garansi">Mac Address</label>
                                                <input required type="text" class="form-control" id="mac_address" name="mac_address" placeholder="Mac Address..." maxlength="17" value="<?php
                                                    echo($data['mac_address']);
                                                ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="tgl_garansi">Id Anydesk</label>
                                                <input required type="text" class="form-control" id="anydesk" name="anydesk" placeholder="Id Anydesk..." maxlength="30" value="<?php
                                                    echo($data['anydesk']);
                                                ?>">
                                            </div>
